...
function ensureConfirmDialogStyles() {
  ...
  style.textContent = `
    ...
    .confirm-icon-wrap.danger { background: #fef2f2; color: var(--error, #c64545); }
    .confirm-icon-wrap.warn { background: #fff7ed; color: #c2410c; }
    .confirm-icon-wrap.info { background: #eff6ff; color: var(--info, #4a90d9); }
    .confirm-icon-wrap.primary { background: #fdf2f0; color: var(--primary, #cc785c); }
    .confirm-title {
    ...
    .confirm-btn:focus-visible {
      outline: 2px solid rgba(204, 120, 92, .35);
      outline-offset: 2px;
    }
    .confirm-btn.danger {
      background: var(--error, #c64545);
      color: #fff;
      border-color: var(--error, #c64545);
    }
    .confirm-btn.warn {
      background: #c2410c;
      color: #fff;
    ...
    .confirm-btn.primary:hover {
      background: var(--primary-active, #a9583e);
      border-color: var(--primary-active, #a9583e);
    }
